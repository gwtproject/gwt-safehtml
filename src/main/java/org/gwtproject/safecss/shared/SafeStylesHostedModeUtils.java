...
public class SafeStylesHostedModeUtils {
   ...
   *
   * <p>
   * NOTE: Running this method in prod mode will always retun null!
   * </p>
   *
   * <p>
  ...
  public static void maybeCheckValidStyleValue(String value) {
    System.out.println("method: maybeCheckValidStyleValue - value >>" + value + "<< - forceCheck >>" + forceCheck + "<< - System.getProperty(\"superdevmode\" >>" + System.getProperty("superdevmode") + "<<");
    if ("on".equals(System.getProperty("superdevmode")) || forceCheck) {
  ...
  static void setForceCheckValidStyleFromProperty() {
    System.out.println("setForceCheckValidStyleFromProperty - System.getProperty(FORCE_CHECK_VALID_STYLES) >>" + System.getProperty(FORCE_CHECK_VALID_STYLES) + "<<");
